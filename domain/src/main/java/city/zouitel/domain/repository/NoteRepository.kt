...
/**
 * Repository interface for accessing and observing collections of [Note] objects.
 * This interface provides different ways to observe notes based on various sorting and filtering criteria.
 */
