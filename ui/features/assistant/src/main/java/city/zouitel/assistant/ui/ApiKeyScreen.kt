...
import city.zouitel.assistant.Constants.GEMINI_API_KEY_INFO
import city.zouitel.assistant.Constants.GEMINI_MODELS_INFO
        ...
        Navigator(CommonBottomSheet {
            ...
            MarkdownText(
                modifier = Modifier
                    .padding(12.dp)
                    .alpha(.5f),
                markdown = """generated by [gemini-2.0-flash-exp]($GEMINI_MODELS_INFO) model.""",
                fontSize = 12.sp,
                color = MaterialTheme.colorScheme.onSurface
            )
